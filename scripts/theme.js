...
function setTheme(theme) {
    ...
    if (theme === 'light') {
        ...
        header.style.setProperty('background-color', 'var(--header-color-light)');
        header.style.setProperty('color', 'var(--text-color-light)');

    } else {
        root.style.setProperty('background-color', 'var(--bg-color-dark)');
        root.style.setProperty('color', 'var(--text-color-dark)');
        header.style.setProperty('background-color', 'var(--header-color-dark)');
        header.style.setProperty('color', 'var(--text-color-dark)');
    }
}
